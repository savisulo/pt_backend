...
let elements = [
        ...
        },
        {
            ...
            cpk_hex: "45ffc7",
            image: {
                "title": "Pure (99.95%) Amorphous Gadolinium, about 12 grams, 2 x 1.5 x 0.5 cm, cast in acrylic glass",
        ...
        },
        {
            ...
            cpk_hex: "00d452",
            image: {
                "title": "Ultrapure (99.997%) Crystalline Thulium, 22.3 grams, 3 x 3 x 2 cm in size",
...
app.get('/api/elements/number/:number', (request, response) => {
...
app.get('/api/elements/name/:name', (request, response) => {
    const name = request.params.name.toLowerCase()
    const element = elements.find(element => element.name.toLowerCase() === name)
...
app.get('/api/elements/symbol/:symbol', (request, response) => {
    const symbol = request.params.symbol.toLowerCase()
    const element = elements.find(element => element.symbol.toLowerCase() === symbol)
